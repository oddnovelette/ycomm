...
class ContactCest
{
    ...
    {
        $I->submitForm('#feedback-form', [
            'FeedbackForm[name]' => 'tester',
            'FeedbackForm[email]' => 'tester.email',
            'FeedbackForm[subject]' => 'test subject',
            'FeedbackForm[body]' => 'test content',
            'FeedbackForm[verifyCode]' => 'testme',
        ]);
    ...
    public function checkContactSubmitCorrectData(FunctionalTester $I)
    {
        $I->submitForm('#feedback-form', [
            'FeedbackForm[name]' => 'tester',
            'FeedbackForm[email]' => 'tester@example.com',
            'FeedbackForm[subject]' => 'test subject',
            'FeedbackForm[body]' => 'test content',
            'FeedbackForm[verifyCode]' => 'testme',
        ]);
